      ...
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                  <button class="btn btn-primary btn-sm btn-menu" type="button" id="filter"><i class="glyphicon glyphicon-filter"></i> Lọc</button>
                  <button class="btn btn-success btn-sm btn-menu" type="button" id="print"><i class="glyphicon glyphicon-print"></i> In</button>
            </div>

            
          </div>
          <center ><h3>Báo cáo công việc hàng ngày</h3></center>
          <div class="gap"></div>
...
<noscript>
    <div>
        ...
        <h4 class="mb-0 text-center"><b>Hệ thống quản lý nhân viên</b></h4>
        <h4 class="mb-0 text-center"><b>Báo cáo công việc hàng ngày</b></h4>
        <div class="mb-0 text-center"><b>kể từ</b></div>
