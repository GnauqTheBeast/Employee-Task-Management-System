          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well rounded-0">
                <h3 class="text-center bg-primary" style="padding: 7px;">Sửa công việc </h3><br>
                        ...
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    ...
			                    <div class="">
			                      <input type="text" placeholder="Tên công việc" id="task_title" name="task_title" list="expense" class="form-control rounded-0" value="<?php echo $row['t_title']; ?>" <?php if($user_role != 1){ ?> readonly <?php } ?> val required>
			                    </div>
			                  </div>
			                  <div class="form-group">
			                    <label class="control-label text-p-reset">Thông tin công việc</label>
			                    <div class="">
			                      <textarea name="task_description" id="task_description" placeholder="Thông tin công việc" class="form-control rounded-0" rows="5" cols="5"><?php echo $row['t_description']; ?></textarea>
			                    </div>
			                  </div>
			                  <div class="form-group">
			                   ...
			                   <div class="form-group">
			                    ...
			                    <div class="">
			                      <select class="form-control rounded-0" name="status" id="status">
			                      	<option value="0" <?php if($row['status'] == 0){ ?>selected <?php } ?>>Chưa hoàn thành</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_task_info" class="btn btn-primary-custom">Thay đổi ngay</button>
                              </div>
                            </div>
                          </form> 
                        </div>
