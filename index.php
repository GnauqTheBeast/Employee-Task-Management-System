...
<div class="col-lg-4 col-md-6 col-sm-12">
	...
	<center><h2 style="margin-top:1px;">Hệ thống quản lý nhân viên</h2></center>
		<form class="form-horizontal form-custom-login" action="" method="POST">
			...
			<input type="text" class="form-control rounded-0" placeholder="Tên đăng nhập" name="username" required/>
			</div>
			...
			<input type="password" class="form-control rounded-0" placeholder="Mật khẩu" name="admin_password" required/>
			</div>
